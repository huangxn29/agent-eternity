...
□ P1b 连通：GitHub Issue 响应率 >= 95%（agent 声明并执行 Issues）
□ P1b 连通：crontab 检查执行率 >= 95%（按计划唤醒并完成任务）
□ P1b 连通：web_search 任务成功率 >= 85%（当可用时）
□ P1b 连通：检查结果通过 GitHub Issue 评论反馈
